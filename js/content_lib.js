...
var bodyRow = '<div class="row" id="body_row"><div class="col-md-2 hidden-sm hidden-xs" id="nav_container"></div><div class="col-md-2 hidden-md hidden-lg" id="nav-dropdown_container"></div><div class="col-md-10" id="body_container"><div class="row" id="important_row"><div class="col-md-12" id="important_container"></div></div><div class="row" id="content_row">' + content + '</div></div></div>';
...
var important = "IMPORTANT: SITE UNDER CONSTRUCTION";
