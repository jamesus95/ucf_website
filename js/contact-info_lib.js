...
$(window).ready(function() {
	...
	createContact("Rebecca Chrch", "Internation Team Leader", ["reb.church@gmail.com"], "I used to be a pole vaulter in high school", "Cheetah", "rc");
	createContact("Danielle Yeasting", "Wednesday Core Leader", ["dmyeasting@gmail.com", "206-331-6527"], "I can lick my elbow.", "Peregrim Falcon or Horse", "dy");
	...
	createContact("Naomi DesChane", "Wednesday Core Leader", ["206-673-7785", '<a href="https://www.facebook.com/naomi.deschane">Facebook</a>'], "I love to go on adventures", "Otter", "nb");
